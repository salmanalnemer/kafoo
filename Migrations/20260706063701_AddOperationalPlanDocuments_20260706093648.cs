...
{
    /// <inheritdoc />
    public partial class AddOperationalPlanDocuments_20260706093648 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "OperationalPlanDocuments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationalPlanDocuments", x => x.Id);
                });
        }
