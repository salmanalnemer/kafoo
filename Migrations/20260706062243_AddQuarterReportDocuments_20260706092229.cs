...
{
    /// <inheritdoc />
    public partial class AddQuarterReportDocuments_20260706092229 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "QuarterReportDocuments",
                columns: table => new
                {
                    ...
                    QuarterLabel = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuarterReportDocuments", x => x.Id);
                });
        }
