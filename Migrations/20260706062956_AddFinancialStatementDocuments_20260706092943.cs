...
{
    /// <inheritdoc />
    public partial class AddFinancialStatementDocuments_20260706092943 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "FinancialStatementDocuments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialStatementDocuments", x => x.Id);
                });
        }
